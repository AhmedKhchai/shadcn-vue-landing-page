    ...
    <div class="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 md:py-32">
      <div class="text-center space-y-8">
        <Badge variant="outline" class="text-sm py-2">
          ...
          <span>Mobile App for Attendance</span>
        </Badge>
        ...
        <div class="max-w-screen-md mx-auto text-center text-5xl md:text-6xl font-bold">
          <h1>
            Transform Your
            <span
              class="text-transparent bg-gradient-to-r from-[#0057B8] to-primary bg-clip-text"
              >Tutoring School
            </span>
            Operations
          </h1>
        ...
        <p class="max-w-screen-sm mx-auto text-xl text-muted-foreground">
          Streamline your administration, enhance student experience, and make data-driven
          decisions with our comprehensive school management system.
        </p>
      ...
      <div class="relative group mt-14">
        ...
        <img
          ...
          :src="
            mode == 'light'
              ? 'scholatech-dashboard-light.png'
              : 'scholatech-dashboard-dark.png'
          "
          alt="Scholatech dashboard preview"
        />
